...
const STORAGE_CONFIGURATION_PATH: &str =
    ".contracts/QD/out/debug/QD-storage_slots.json";
const CONTRACT_BIN_PATH: &str = "./contracts/QD/out/debug/QD.bin";
